...
console.log('Kendall Similarity:', kendallCorrelationSimilarity(vecA, vecB).toFixed(4));
...
console.log('Kendall Similarity:', kendallCorrelationSimilarity(vecC, vecD).toFixed(4));
